...
- [#3](https://github.com/dwsdolce/pdfarranger-qt/issues/3) — stage 0, the guard tests
- [#4](https://github.com/dwsdolce/pdfarranger-qt/issues/4) — stage 1, the merge tool
- [#5](https://github.com/dwsdolce/pdfarranger-qt/issues/5) — stage 2a, the 390 interface messages
- [#6](https://github.com/dwsdolce/pdfarranger-qt/issues/6) — stage 2b, the 37 user-guide messages
- [#7](https://github.com/dwsdolce/pdfarranger-qt/issues/7) — stage 3, keeping them filled
...
([#3](https://github.com/dwsdolce/pdfarranger-qt/issues/3)).
