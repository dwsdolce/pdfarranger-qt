...
What is left is tracked as issues, not as checkboxes here — a checkbox in a
document is a to-do list nobody is assigned to and nothing closes:
...
- [Issue #5](https://github.com/dwsdolce/pdfarranger-qt/issues/5) — stage 2a, the 390 interface messages
- [Issue #6](https://github.com/dwsdolce/pdfarranger-qt/issues/6) — stage 2b, the 37 user-guide messages
...
**Stage 1 — the pipeline, proved on one language. Done.** Not hand-written `.po`
