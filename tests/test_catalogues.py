...
- **mnemonics kept** — 87 of 2475 are dropped, in 13 of the 33 languages;
...
MNEMONICS_LOST = {
    "ar": 1, "ca": 34, "ca@valencia": 18, "da": 2, "de": 2,
    "es": 13, "eu": 4, "hu": 1, "ka": 1,
...
CLASHES = {
    "ar": 2, "ca": 0, "ca@valencia": 1, "cs": 2, "da": 2, "de": 10,
    "el": 2, "en": 5, "es": 5, "eu": 7, "fi": 6, "fr": 4,
    "he": 3, "hr": 3, "hu": 3, "id": 11, "is": 3, "it": 7,
    "ja": 4, "ka": 4, "ko": 4, "nl": 6, "oc": 10, "pl_PL": 2,
    "pt_BR": 7, "pt_PT": 5, "ru": 5, "sl": 2, "sv": 4, "tr": 8,
    "uk": 5, "vi": 9, "zh_CN": 5, "zh_TW": 4,
}
